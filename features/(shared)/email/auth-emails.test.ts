...
describe('welcomeEmail', () => {
	test('returns branded email for pro user with course link', () => {
		const email = welcomeEmail({ name: 'Maria', hasSubscription: true, dashboardUrl: 'https://app.com/course', pricingUrl: 'https://app.com/pricing' })
		assertValidEmail(email)
	...
	test('returns branded email for free user with pricing link', () => {
		const email = welcomeEmail({ name: 'John', hasSubscription: false, dashboardUrl: 'https://app.com/course', pricingUrl: 'https://app.com/pricing' })
		assertValidEmail(email)
...
describe('passwordChangedEmail', () => {
	test('returns branded alert email with date and recovery link', () => {
		const email = passwordChangedEmail({ name: 'Maria', date: '2026-04-07T12:00:00Z', forgotPasswordUrl: 'https://app.com/forgot' })
		assertValidEmail(email)
