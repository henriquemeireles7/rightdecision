...
export function paymentConfirmationEmail(vars: {
	...
	const content = `
<p>Hi ${vars.name},</p>
<p><strong>${vars.amount} — Right Decision: The Course (Annual)</strong></p>
<p>Your access is active until ${vars.renewalDate}.</p>
...
export function renewalReceiptEmail(vars: {
	...
	const content = `
<p>Hi ${vars.name},</p>
<p>${vars.amount} charged to card ending in ${vars.cardLast4}.</p>
<p>Your access continues through ${vars.nextRenewalDate}.</p>
...
export function paymentFailedEmail(vars: {
	...
	const content = `
<p>Hi ${vars.name},</p>
<p>Your payment of ${vars.amount} for Right Decision couldn't be processed.</p>
...
export function renewalReminderEmail(vars: {
	...
	const content = `
<p>Hi ${vars.name},</p>
<p>Your Right Decision subscription (${vars.amount}/year) renews on ${vars.renewalDate}.</p>
<p>Payment method: ${vars.cardBrand} ending in ${vars.cardLast4}</p>
...
<p>You'll continue to have access until ${vars.periodEndDate}.</p>
