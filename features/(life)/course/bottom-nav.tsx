  ...
  return (
    ...
    >
      <div class="flex items-center justify-around h-[44px] px-4">
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill={isBookmarked ? 'currentColor' : 'none'} aria-hidden="true">
            <path d="M10 3.22l-.61-.6a5.5 5.5 0 00-7.78 7.77L10 18.78l8.39-8.4a5.5 5.5 0 00-7.78-7.77l-.61.61z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </button>
