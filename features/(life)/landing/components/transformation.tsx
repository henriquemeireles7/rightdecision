    ...
    <section class="bg-cream py-16">
      <div class="max-w-[800px] mx-auto px-4">
        ...
        <p class="max-w-[640px] mx-auto mt-6 text-body leading-[1.7] text-center">
          Imagine it's a Tuesday. Three months from now. The thing you've been
          avoiding? Done. Behind you. Not because you finally "healed enough."
          Because you decided, and then you did it.
        </p>
        <p class="max-w-[640px] mx-auto mt-4 text-body leading-[1.7] text-center">
          You wake up without the Sunday dread. You go to work on something you
          chose. At 3pm you have energy. You don't check your bank account
          before buying groceries.
        </p>

        <p class="max-w-[640px] mx-auto mt-8 text-body text-center">
          Maria scored 18 out of 50 on her life assessment.
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-sand rounded-[12px] p-6">
            <h3 class="font-semibold text-muted text-sm uppercase tracking-wide mb-4">
              Before
            </h3>
            <ul class="space-y-3">
              {BEFORE.map((item) => (
          ...
          <div class="bg-surface-white rounded-[12px] p-6 border border-linen">
            <h3 class="font-semibold text-gold text-sm uppercase tracking-wide mb-4">
              After
            </h3>
            <ul class="space-y-3">
              {AFTER.map((item) => (
