...
- Do NOT use AskUserQuestion.`,
        ...
        const hasYamlFrontmatter =
          checkpointContent.includes('---') && checkpointContent.includes('status:')
        const hasBranch =
          checkpointContent.includes('branch:') || checkpointContent.includes('main')
        ...
        console.log(
          `Checkpoint: ${checkpointFiles.length} files created, YAML frontmatter: ${hasYamlFrontmatter}, branch: ${hasBranch}`,
        )
      },
      180_000,
    )
